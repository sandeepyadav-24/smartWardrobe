...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto bg-[#f8fafc] p-4 md:p-8">
      {/* Header */}
      <motion.div
        ...
        {features.map((feature) => (
          <motion.button
            ...
            className={`p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all
                     ${
                       currentMode === feature.id ? "ring-2 ring-blue-500" : ""
                     }`}
          >
          ...
          >
            <div className="max-w-md mx-auto space-y-6">
              ...
              <p className="text-gray-600">
                ...
                meaningful insights. You've been using the app for {daysOfData}{" "}
                {daysOfData === 1 ? "day" : "days"}.
              </p>
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => (window.location.href = "/dashboard/wardrobe")}
